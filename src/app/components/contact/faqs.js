...
export default function Faqs() {
  ...
  return (
    <>
      <section className="max-w-4xl mx-auto md:py-20 py-8 px-6">
        {/* HEADER */}
        <motion.div
        ...
        >
          <h2 className="text-4xl md:text-5xl Merriweather mb-8 Arimo">
            Our Philosophy
          </h2>
          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className=" text-lg font-semibold Merriweather">{faq.question}</span>
        ...
        <div className="max-w-4xl w-full text-center space-y-10">
          <div>
            ...
            <motion.h2
              ...
              className="text-3xl md:text-4xl Merriweather text-black"
            >
              {" "}
              Quick Contact{" "}
            </motion.h2>{" "}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <motion.a
              ...
              className="flex items-center gap-3 px-6 py-3  rounded-2xl bg-black text-white hover:bg-gray-800 transition"
            >
              {" "}
            ...
            <motion.a
              ...
              target="_blank"
              className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-green-500 text-white hover:bg-green-600 transition"
            >
              <svg
            ...
            <motion.a
              ...
              target="_blank"
              className="flex items-center gap-3 px-6 py-3 rounded-2xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white hover:opacity-90 transition"
            >
              {" "}
              <svg
                viewBox="0 0 448 512"
